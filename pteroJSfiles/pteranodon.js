...
const renderer = new THREE.WebGLRenderer(
  {
    canvas: document.querySelector('#pterano'), alpha: true
  });
...
const pteroTexture = new THREE.TextureLoader().load('pteroUV/pteranodonSkin.png');
const ptero = await loader.loadAsync('ptero3D/pteranodon.obj');
...
//   ptero.rotation.z += 0.1;
ptero.rotation.x += (targetRotX - ptero.rotation.x) * pteroSize/10 + scrollPosY/4.8;
