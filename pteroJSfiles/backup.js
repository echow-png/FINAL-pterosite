...
const pteroTexture = new THREE.TextureLoader().load('pteroUV/pteroBaking.png');
const ptero = await loader.loadAsync('ptero3D/ptero3-1.obj');
...
const pointLight = new THREE.PointLight(0xFFF5B3, 25, 0);
...
const ambLight = new THREE.AmbientLight(0x283166, 10);
...
let targetRotX = 0, targetRotY = 0;
 ...
 targetRotY = mouseX * Math.PI * 0.3 - 0.4;  // left-right
