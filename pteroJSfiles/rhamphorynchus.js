...
const camera = new THREE.PerspectiveCamera(58 ,window.innerWidth/window.innerHeight, 1, 1000 );

const renderer = new THREE.WebGLRenderer(
  {
    canvas: document.querySelector('#rhampho'), alpha: true
  });
...
const pteroTexture = new THREE.TextureLoader().load('pteroUV/rhamphorynchusSkin.png');
const ptero = await loader.loadAsync('ptero3D/rhamphorynchus.obj');
